    ...
    public sealed partial class Scenario_PredefinedDictationGrammar : Page
    {
        ...
        private async void RecognizeWithoutUIDictationGrammar_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    textBlockFileSelected.Text = "Currently playing file: " + selectedFile.Name;
                    var stream = await selectedFile.OpenAsync(Windows.Storage.FileAccessMode.Read);
        ...
        //private async void SingleShotSpeechRecogRepeat()
        //{
        //    // Start recognition.
        //    try
        //    {
        ...
        //        while (this.selectedFile != null && isPlaying)
        //        {
        ...
        //            await Task.Delay(TimeSpan.FromSeconds(1.5 + timeToWait));
        ...
        private async void btnSelectFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (file != null)
            {
                ...
                textBlockFileSelected.Text = "Picked Folder: " + file.Name;
